...
contract Shinsekai is Ownable, ERC721A, ReentrancyGuard {
    ...
    address private fundWallet =
        payable(0x91246F3C3b163DaDbF9dDd1b4B4dE28cb2BEB737); // Owner Fund Wallet Address
    address private devOneWallet =
        payable(0x5362d66CF2B2259ad631Fd6D965dEf352AbC98D8); // Developer One Wallet Address

    bool public SALE_OPEN = false;

    uint256 private _mintPasskey = 7;

    mapping(address => uint256) public whitelist;

    constructor(uint256 maxBatchSize_, uint256 collectionSize_)
        ERC721A("ShinsekaiNFT", "SHIN", maxBatchSize_, collectionSize_)
    {
    ...
    function withdrawAll() external onlyOwner nonReentrant {
        ...
        uint256 devOneBalance = totalBalance / 30; // 7% of total sale
