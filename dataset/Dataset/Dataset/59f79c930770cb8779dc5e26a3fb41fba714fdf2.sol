...
contract BlockchainOdyssey is ERC1155, Ownable, Pausable, ERC1155Supply {
    constructor() ERC1155("") {}
    ...
    function uri(uint256 tokenId) override public view returns (string memory) {
        ...
        return string(abi.encodePacked("https://blockchainodyssey.com/DataApi/", Strings.toString(tokenId),".json"));
    }
    ...
    function contractURI() public pure returns (string memory) {
        return "https://blockchainodyssey.com/DataApi/Blockchain-Odyssey.json";
    }
}