...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x86cBf57556cbf859334821606D930056a16Ca0cF];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifrocak45ach3t7s6gifjjdawl7svkwnhapg3r6vi7j7djghrjfyu/";
...
// File: contracts/ThenewmetatcgseriesoneContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ThenewmetatcgseriesoneContract is RamppERC721A {
    constructor() RamppERC721A("THE NEW META TCG  SERIES ONE", "TNM"){}
}
